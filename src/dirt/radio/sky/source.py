...
engine via ``dirt.inference.build_forward_fn``.
"""
...
from dirt.radio.sky.model import AbstractSkyModel
...
class SkySourceOperator(AbstractOperator):
    ...
    Attributes:
        sky_model: what the sky is — :class:`~dirt.radio.sky.model.AbstractSkyModel`.
        projector: how it is seen — :class:`~dirt.radio.sky.projection.AbstractSkyProjector`.
    """
