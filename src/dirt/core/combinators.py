...
:class:`~dirt.core.pipeline.Pipeline` composes operators *sequentially*;
...
from dirt.core.errors import PipelineError, StateValidationError
from dirt.core.operator import AbstractOperator
from dirt.core.pipeline import resolve_names, validate_operators
...
class SumOperator(AbstractOperator):
    ...
    def replace_branch(self, index: int | str, operator: AbstractOperator) -> "SumOperator":
        ...
        Parity with :meth:`~dirt.core.pipeline.Pipeline.replace_stage`.
        """
