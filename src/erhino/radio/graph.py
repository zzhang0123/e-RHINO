"""The canonical single-dish signal-path graph and graph-guided assembly.
...
and compiles it to the equivalent ``Pipeline``/``SumOperator`` nesting::
    ...
    from erhino.radio.graph import assemble
...
from erhino.core.graph import At, NodeSpec, SignalGraph, register_graph
from erhino.core.graph import assemble as _assemble
...
def assemble(*operators: AbstractOperator | At):
    """Assemble radio operators on the canonical single-dish graph."""
