...
- **Monte Carlo pushforward** — :func:`push_forward` vmaps ``forward`` over
  ...
  :func:`~erhino.inference.numpyro_bridge.predict_from_samples`), giving the
...
:class:`~erhino.inference.calibrate.GradientCalibrator`, take
...
:func:`~erhino.inference.forward.build_forward_fn` — uncertainty tooling
...
def fisher_information(
    ...
    :class:`~erhino.inference.likelihood.MaskedGaussianLikelihood`.
